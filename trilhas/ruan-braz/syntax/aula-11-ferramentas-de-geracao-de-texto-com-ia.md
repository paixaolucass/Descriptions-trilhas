...
- Identificar as cinco principais LLMs para geração de texto e o que diferencia cada uma
- Identificar as ferramentas derivadas especializadas em copy, escrita criativa, gramática e e-commerce, e quando cada uma faz sentido
- Distinguir o Overchat da Overlens das ferramentas do mercado pelos seus agentes, modelos mentais e prompts de ação

## As cinco principais: onde qualquer uma resolve

A aula começa pelos modelos base, as LLMs que competem no topo do mercado e das quais a maioria das outras ferramentas deriva.
...
A partir daqui, a aula apresenta ferramentas que usam os modelos das cinco principais como base, mas adicionam estruturas e interfaces específicas para determinados usos.

**Qbot** é focado em quem trabalha com texto de forma ampla. Oferece parafrasear conteúdo com base em referências, checagem de gramática, detector de texto gerado por IA, detector de plágio, humanizador de texto, chat com IA, sumarizador, gerador de citações e tradução. Tem também uma extensão para Chrome que guarda informações relevantes em uma biblioteca pessoal enquanto você navega. É uma ferramenta com plano gratuito disponível para teste.
...
**Anyword** segue na mesma linha das ferramentas de copy com templates pré-moldados, com foco em marketing e com custo geralmente menor do que as alternativas maiores.
...
**Hypotenuse** é apresentada fora da ordem da lista por ser específica para um contexto muito definido: e-commerce. Gera tags de produtos, títulos, descrições e características, tudo com SEO integrado. Também trabalha com variações de imagem. Para quem produz volume de conteúdo de produto, é uma ferramenta que resolve um problema específico com eficiência.
...
O Overchat é o chat com IA da própria plataforma Overlens. Usa ChatGPT como modelo base e adiciona três camadas que as ferramentas externas não entregam.

A primeira são os **agentes**, chamados de lentes, configurados pela equipe da Overlens: cronicante, narrativista, neologista, senhor paradoxo, dilema, voz de marca, buyer persona, entre outros. Cada agente já vem com instruções preparadas para determinado uso.

A segunda são os **modelos mentais**: mais de 90 estruturas de raciocínio mapeadas pela equipe, lentes simbólicas, pensamento formal, cognitivo, prático estratégico, quantitativo matemático, relacional e sistêmico. Ativados junto a um prompt, eles orientam a IA a simular raciocínios mais avançados e a sair do genérico.

A terceira são os **prompts de ação**: escrever um manifesto, gerar um nome, criar uma descrição de post, analisar um briefing, criar um briefing a partir de uma reunião, desenhar uma proposta de valor, criar um pitch de um minuto. São templates que funcionam de forma semelhante aos das outras ferramentas, mas com o contexto específico da metodologia Overlens. O acesso usa os fractais da plataforma.
