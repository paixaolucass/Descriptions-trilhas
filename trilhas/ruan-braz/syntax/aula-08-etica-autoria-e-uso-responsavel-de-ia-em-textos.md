...
- Distinguir ética de moral no contexto da escrita e reconhecer por que produzir textos com IA exige responsabilidade sobre as consequências
- Reconhecer o impacto real que textos bem ou mal escritos têm sobre a vida das pessoas, incluindo quem considera não ser suscetível a isso
- Aplicar três perguntas de consciência antes de qualquer produção de texto com ou sem IA
...
O exemplo mais óbvio é a desinformação: qualquer pessoa pode entrar em um modelo de linguagem, pedir um texto convincente sobre algo falso, e publicar. Muitas outras pessoas vão ler e ser impactadas. O texto é uma interface, um meio para carregar uma mensagem. A mensagem é o que tem poder.
...
Se Steve Jobs não era imune, ninguém é. O cérebro humano é facilmente enviesado. Nós enxergamos padrões onde não existem. A inteligência não nos protege, em alguns casos, nos torna mais confiantes em raciocínios equivocados. Técnicas de escrita que influenciam o comportamento existem e funcionam. Uma vez que você aprende a usá-las, a responsabilidade é sua.
...
## As três perguntas de consciência

A aula não se aprofunda em teoria ética, mas deixa um exercício prático que precede qualquer produção de texto. Três perguntas que devem ser respondidas antes de abrir qualquer ferramenta.

A primeira: qual é o meu objetivo com esse texto? A segunda: quem vai ler esse texto? A terceira: que tipo de resultado eu gero para essas pessoas?
