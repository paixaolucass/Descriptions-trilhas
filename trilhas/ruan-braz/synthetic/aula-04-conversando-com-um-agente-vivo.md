...
- Aplicar o processo de criação de personagens com voz no Character.ai a partir de uma ficha de persona
- Reconhecer as limitações atuais das ferramentas gratuitas de áudio e o que esperar de uma conversa com um agente sintético
- Identificar usos éticos e limitações de personas com voz, incluindo os riscos de deepfakes e uso não autorizado de imagem

## Da leitura para a voz

Nas aulas anteriores, a persona existia em texto: você conversava com ela digitando e ela respondia digitando. Nesta aula, a persona ganha voz. É possível ligar para ela e conversar em tempo real, como se fosse uma pessoa do outro lado da linha.

A ferramenta usada para isso é o Character.ai, uma plataforma que o Google adquiriu e que permite criar personagens com voz que respondem via chamada de áudio. A experiência ainda tem imperfeições visíveis, especialmente nas versões gratuitas, mas o conceito está funcionando: uma persona documentada em texto pode se tornar um agente que fala.

## Criando um personagem no Character.ai
...
Mesmo com as limitações, o exercício de conversar com a persona em áudio revela algo que o texto não entrega: o ritmo da conversa, a naturalidade das pausas e a coerência do personagem em resposta a perguntas que não foram previstas na construção.
...
Isso não é coincidência. É o modelo de linguagem por trás do personagem respondendo a partir de um ponto de vista construído. O personagem não sabe que é IA, mas o modelo sabe o que o personagem diria.
