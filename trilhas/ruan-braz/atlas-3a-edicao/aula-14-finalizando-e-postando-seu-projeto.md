...
A aula começa com a decisão de publicar o Brand System. O professor avisa que publicar pode parecer simples, mas envolve cuidados, principalmente quando há variáveis de ambiente, Supabase, autenticação e storage.
...
O professor contextualiza a Vercel no mundo da IA. Antes de ferramentas como Lovable se popularizarem, a Vercel já havia lançado o V0, conectado à lógica de criação de interfaces por IA.
...
Ferramentas como Lovable, Bolt e V0 foram importantes para popularizar a criação de sistemas, mas o professor defende que trabalhar direto em IDE com agente via terminal oferece outro nível de controle, custo e personalização.
...
O professor lembra que, em um processo profissional, o ideal seria usar Git e GitHub, com commit e push antes do deploy. Como isso não foi ensinado na trilha, o deploy é feito de forma mais direta.

## Publicando com Claude e Vercel CLI

O professor pede ao Claude para instalar a Vercel CLI, conectar a conta da Vercel e publicar o Brand System no projeto criado. Também fornece o e-mail da conta e o Project ID para reduzir ambiguidade.
...
A demonstração encontra alguns problemas porque o professor tem mais de uma conta Vercel aberta. O Claude tenta usar uma conta diferente, e o professor precisa desconectar e reconectar na conta correta.
...
O professor explica que, em uma situação normal, tiraria print do erro, mandaria para o Claude e pediria para corrigir a leitura dos Markdowns e a configuração do storage.

Como a aula acontece em evento ao vivo e o objetivo é mostrar o caminho geral, o professor encerra a trilha mostrando que os problemas são específicos e corrigíveis em novas rodadas de trabalho.
