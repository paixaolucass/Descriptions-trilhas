# Uma pequena recapitulação antes de seguir
...
- Distinguir IA no navegador, aplicativo desktop e terminal
- Reconhecer por que Claude Code, Codex e Gemini CLI ampliam a capacidade da IA
- Identificar o papel do Antigravity no fluxo de criação
- Executar a abertura de pasta e terminal dentro da IDE
...
Por isso, a aula diferencia Claude no navegador de Claude Code. Ambos podem usar o mesmo modelo de linguagem, mas são produtos diferentes. Claude Code é voltado para agir no projeto, escrever arquivos, rodar comandos e colaborar como agente dentro do ambiente local.
...
Por isso, o terminal é recomendado para o Atlas. Ele pode assustar no início, mas é o caminho usado para acordar o agente dentro do computador e permitir que ele trabalhe com arquivos, comandos e projeto.

## Alternativas com Codex e Gemini
...
## Visualização de arquivos e hierarquia

A aula também explica que os arquivos exibidos com cores e marcações no editor não estão assim por acaso. A IDE destaca elementos para ajudar o usuário a enxergar hierarquia e encontrar informações mais rapidamente.

Um arquivo sem destaque pode parecer mais limpo, mas torna tudo visualmente equivalente. O realce de sintaxe e as cores ajudam a perceber títulos, caminhos, chaves, comentários e estruturas importantes do arquivo.

Essa explicação prepara os alunos para perderem menos medo da tela de código. A promessa da aula é que, ao longo do processo, eles entenderão a lógica do que está acontecendo e poderão trabalhar com mais confiança.

## Coloque em prática

Abra o Antigravity, selecione a pasta do seu projeto e confirme se o painel de arquivos está visível.

Depois, abra o terminal integrado e teste o agente que você pretende usar: Claude Code, Codex ou Gemini CLI.
