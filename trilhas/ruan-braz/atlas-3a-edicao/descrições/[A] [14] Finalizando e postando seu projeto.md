Cálculo interno: [10 blocos] / [33 parágrafos totais] / [1100 palavras estimadas] / [1100 ÷ 200 = 6 minutos]
...
- Conhecer ferramentas de segurança usadas em projetos profissionais
...
## Ferramentas de segurança para projetos em produção

O Ruan e o Rafael indicam algumas ferramentas externas que complementam o trabalho de deploy seguro.

TruffHog é uma ferramenta que escaneia repositórios Git em busca de credenciais expostas, como chaves de API, tokens e senhas que podem ter sido commitados por acidente. Ela verifica o histórico completo do repositório e detecta mais de 800 tipos de segredos. Em projetos com Claude Code, o risco de expor variáveis de ambiente existe, e uma ferramenta como essa ajuda a identificar esse tipo de problema antes que cause dano.

O Ruan também menciona o Project GlassWing, uma iniciativa da Anthropic que usa o próprio Claude para encontrar vulnerabilidades em softwares de código aberto usados em infraestruturas críticas. É um exemplo direto do que IA pode fazer no campo de segurança: varrer repositórios inteiros, identificar falhas e contribuir com correções antes que sejam exploradas.

Para quem quiser acompanhar vulnerabilidades conhecidas em softwares, o Ruan indica a base de dados do NIST, chamada National Vulnerability Database. É onde ficam catalogadas falhas de segurança com nível de gravidade, data de descoberta e recomendações de correção.

Por fim, para verificar se um e-mail foi exposto em vazamentos de dados, a ferramenta mais usada é o Have I Been Pwned. Basta digitar o e-mail e o site informa em quais vazamentos ele apareceu. É útil para qualquer pessoa que usa o mesmo e-mail em vários serviços.
...
## Links e ferramentas citados

| Ferramenta | Link | Para que serve |
|---|---|---|
| TruffHog Security | https://trufflesecurity.com/trufflehog | Detectar credenciais vazadas em repositórios Git |
| Project GlassWing (Anthropic) | https://www.anthropic.com/glasswing | Iniciativa da Anthropic para encontrar vulnerabilidades em software open source com IA |
| Relatório do Project GlassWing | https://www.anthropic.com/research/glasswing-initial-update | Primeiros resultados: mais de 10.000 vulnerabilidades encontradas |
| National Vulnerability Database | https://nvd.nist.gov/ | Banco de dados oficial de falhas de segurança em softwares |
| Have I Been Pwned | https://haveibeenpwned.com/ | Verificar se um e-mail foi exposto em vazamentos de dados |
