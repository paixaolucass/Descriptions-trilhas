Cálculo interno: [7 blocos] / [23 parágrafos totais] / [844 palavras estimadas] / [844 ÷ 200 = 5 minutos]

# Bônus: Temperatura do chat
...
- Reconhecer como o chat do evento foi analisado como dado
- Identificar critérios de destaque além do volume de mensagens
- Reconhecer críticas construtivas e padrões emocionais do evento
- Aplicar a ideia de memorial de comunidade em projetos próprios
...
Blanche Garcia aparece como destaque do evento, com 534 mensagens e presença cinco vezes acima da média do top 10. A IA identifica nela uma espécie de termômetro emocional do chat, alguém que elevou a moral, fez perguntas, distribuiu dicas e reuniu links.
...
O ranking do top 10 inclui participantes que ajudaram de maneiras diferentes. Helena Maia foi destacada por explicar tecnicamente e auxiliar colegas durante a instalação do Antigravity, GitHub, tokens e diferenças entre ferramentas.

Alan aparece por respostas técnicas curtas e diretas sobre Cloudflare, `.env`, `.env.example`, segurança de chaves, OpenRouter e trocas de variáveis. Leandro é citado como engenheiro de sistemas e empresário que explicou CLI, chat, Supabase, Vercel, servidores e limites de ferramentas como Lovable.

Priscila Ramos se destaca pela combinação de densidade conceitual, humor e observações de UX. Marja aparece por reflexões sobre paralelização, tecnofeudalismo, cosmovisão de empreendedores e AI First. Kiza, Franciele, Clara, Fran e Eduardo também são reconhecidos por contribuições técnicas, conceituais, organizacionais ou didáticas.
...
O dashboard destaca participantes que criaram valor de outras formas. Jefferson é citado como rei dos memes, Mayamun como voz da disciplina pedagógica, Irã como suporte técnico de bastidor e Luiz como presença bem-humorada com leitura geopolítica.

Carolina é reconhecida por construir durante o evento um questionário Brand System próprio com prompts navegáveis. Bruna é lembrada por reforçar que a própria IA pode ensinar o passo a passo de instalação. Gustavo é citado por divulgar o SOS Atlas e ajudar com dicas de print e Caveman.

O dashboard também identifica microcomunidades, como os ansiosos por tokens, os anjos da guarda, os perdidos do terminal, a tropa da Vanguarda, designers de carreira, devs infiltrados, time do Mac e empreendedoras de CRM.
...
A aula demonstra, na prática, como dados de comunidade podem ser transformados em narrativa, reconhecimento e cultura. O chat deixa de ser ruído e vira material simbólico do próprio Atlas.

## Coloque em prática

Se você organiza eventos, comunidades ou mentorias, exporte as interações e analise padrões de ajuda, dúvida, humor, frustração e participação.

Depois, transforme essa análise em um memorial ou relatório que reconheça contribuições reais e gere aprendizado para melhorar o próximo encontro.
