Cálculo interno: [6 blocos] / [20 parágrafos totais] / [825 palavras estimadas] / [825 ÷ 200 = 5 minutos]

# Metodologia Overlens
...
- Identificar as ferramentas usadas na trilha
- Distinguir agente de código, IDE, banco de dados, storage e hospedagem
- Reconhecer as camadas da metodologia Overlens para construção de marca
- Estruturar a visão geral do Brand System que será criado
...
O Antigravity é apresentado como uma IDE, ou ambiente integrado de desenvolvimento. A função dele é dar visão de pastas, arquivos e projeto inteiro em um só lugar, facilitando a organização para quem não quer trabalhar apenas no terminal.

O terminal isolado permite conversar com o Claude Code, mas não oferece a mesma visão clara dos arquivos. No Antigravity, o aluno consegue ver a estrutura do projeto, abrir arquivos, acompanhar mudanças e usar o terminal no mesmo ambiente.

Essa combinação entre Claude Code e Antigravity é parte da metodologia porque permite que o aluno gerencie o projeto sem depender apenas de comandos soltos, janelas separadas ou pastas abertas manualmente.
...
Essa camada será trabalhada com mais profundidade no segundo dia, mas a aula já estabelece a lógica: para um Brand System funcionar em equipe, ele precisa ter dados, arquivos, permissões e login.

## Hospedagem e funcionamento em produção
...
## As camadas de conteúdo da metodologia Overlens

A metodologia de conteúdo apresentada vem de seis anos de ensino de branding e design de marcas. Ela organiza a construção de marca em camadas, começando por investigação de negócio, mercado e público.

Depois da investigação, vem a estratégia de marca, com posicionamento, personas, diferenciais estratégicos e decisões que definem como a marca se coloca no mercado. Em seguida, aparece o núcleo da marca, onde entram DNA, virtudes, atributos e arquétipos.

A metodologia também inclui universo verbal e universo visual. O universo verbal define voz, vocabulário, tom e linguagem. O universo visual trata de símbolos, logotipo, cor, tipografia, diretrizes e estilo visual.

## A visão geral do que será construído
...
Liste quais ferramentas você pretende usar na trilha: Claude Code, Codex CLI, Gemini CLI, Antigravity ou aplicativo de desktop.

Depois, organize em um documento simples as três camadas do seu projeto: construção, infraestrutura e diretrizes de marca.
