...
- Identificar a origem e o propósito do Double Diamond como metodologia universal de design
- Distinguir as quatro etapas do Double Diamond e o papel de cada uma no processo criativo
- Reconhecer como o processo funciona de forma não linear, com iterações e retornos entre etapas
- Aplicar a estrutura expandida do Double Diamond com seus princípios, camadas e Methods Banks

## O Design Council e a origem do Double Diamond

O Design Council é uma fundação britânica criada em 1944, com décadas de atuação no campo do design e da inovação. O Double Diamond, no entanto, surgiu apenas em 2005, quando a organização formalizou uma representação visual do processo de design que pudesse ser descrita de maneira padronizada.

A necessidade surgiu de uma pergunta feita pelo então diretor de design e inovação do Design Council, Richard Eisermann: "Como descrevemos o processo de design?" Não havia uma forma padrão de fazer isso, e essa pergunta simples, mas afiada, levou à criação da metodologia que hoje completa 20 anos.

## O que é o Double Diamond

O Double Diamond é definido pelo próprio Design Council como uma representação universal aceita do processo de design. O nome vem da forma visual do diagrama, que lembra dois diamantes unidos, representando as quatro etapas principais do processo.

O objetivo da metodologia foi deliberadamente universal: ela descreve as etapas de qualquer projeto de design e inovação, independentemente dos métodos e ferramentas utilizados. Não importa se a área é gráfico, produto, moda, ambiente ou jogos. A estrutura se aplica a todas.

## As quatro etapas do processo

As quatro etapas do Double Diamond são descoberta, definição, desenvolvimento e entrega. Cada par de etapas forma um dos dois diamantes, alternando entre momentos de abertura e fechamento do processo.

Na etapa de descoberta, o objetivo é ampliar as possibilidades, explorar o problema e gerar alternativas. Na definição, o processo se afunila: de tudo que foi gerado, seleciona-se o que é mais relevante para seguir adiante.

No desenvolvimento, as ideias selecionadas são trabalhadas, testadas e refinadas em ciclos. Na entrega, o processo converge novamente para escolher e finalizar a melhor opção. Essa alternância entre abertura e fechamento é o que dá forma aos dois diamantes do diagrama.
...
## Como usar o Double Diamond na prática
...
A estrutura mais ampla do Double Diamond adiciona duas camadas além das quatro etapas centrais. Na parte superior do diagrama, aparece a camada de engajamento, voltada para construir relacionamentos entre diferentes stakeholders e parceiros envolvidos no projeto.

Na parte inferior, está a camada de liderança, que tem como foco criar as condições para a inovação acontecer. Isso inclui mudanças culturais, desenvolvimento de habilidades e transformação de mentalidade. Essas duas camadas envolvem o processo central e indicam que o Double Diamond não trata apenas das etapas criativas, mas também do contexto humano e organizacional em que o design acontece.

## Princípios do Design Thinking no Double Diamond
...
- Acesse o site do Design Council e leia a página do Double Diamond com tradução automática.
- Desenhe à mão as quatro etapas do Double Diamond e escreva uma frase descrevendo o que acontece em cada uma.
- Identifique um projeto pessoal ou profissional e distribua suas fases pelas quatro etapas da metodologia.
- Observe onde o processo exigiu retornos e marque no diagrama quais iterações ocorreram.
