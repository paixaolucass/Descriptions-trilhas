...
- Distinguir briefing de pesquisa, dossiê, proposta e contrato
- Identificar a função do briefing como documento de gestão de projeto
- Estruturar um briefing a partir da natureza do projeto, diagnósticos e critérios
- Reconhecer os limites do briefing dentro de um processo de design estratégico

## O briefing além do óbvio

A aula apresenta o briefing como mais do que um formulário ou um documento inicial. O foco não está apenas em criar um briefing, mas em reconhecer o que ele é, por que ele importa, quais são seus limites e quando ele não deve receber todas as expectativas de um projeto.

O briefing é tratado dentro do processo de design e da metodologia de design. Ele serve para ajudar o designer a gerar mais resultado para os clientes, desde que seja usado como parte de um processo maior e não como substituto da investigação, da estratégia ou da criação.
...
Essa analogia prepara a relação com o briefing. Fazer um resumo de algo que não foi vivido produz um pseudo resumo. Em projetos de design, quando o designer tenta construir um projeto estratégico apenas com informações superficiais do cliente, ele corre o risco de fazer o resumo de um livro que ainda não leu.
...
O debriefing, por outro lado, era o relatório posterior à missão. Enquanto o briefing antecedia a ação e ajudava a definir tática ou estratégia, o debriefing registrava o que aconteceu, quais foram as perdas, quais foram os ganhos e o que foi ou não conquistado.

Mais tarde, agências de publicidade e marketing começaram a usar o termo para nomear o documento que resumia a necessidade de um projeto. Ele passou a servir para gerenciar o projeto, alinhar expectativas com o cliente, entender necessidades, definir objetivos e orientar o caminho do trabalho.
...
Também não é um dossiê. O dossiê é o arquivo geral que reúne todos os documentos de um projeto, de uma marca ou de uma pesquisa. Ele aparece quando a pesquisa está concluída. O briefing aparece no início da pesquisa e não autoriza o designer a pular investigação, estratégia e alinhamento antes da criação.

O briefing não é uma proposta. Existe o pre-briefing, feito antes do fechamento do projeto para entender necessidades, natureza do trabalho e contexto do cliente. Mas enviar esse material como proposta reduz uma oportunidade comercial importante, porque a proposta serve para vender, encantar e valorizar o projeto.

Por fim, o briefing não é contrato. Ele pode registrar prazo, orçamento, cronograma, objetivo e critérios, mas o contrato precisa de cláusulas e proteções próprias. Usar o briefing como contrato expõe o projeto a riscos, porque há informações jurídicas e comerciais que o briefing não trata.
...
O briefing também precisa identificar quem toma as decisões. Se o designer conduz pesquisa, estratégia e criação com uma pessoa, mas no final o projeto depende de um sócio que nunca participou do processo, esse sócio tende a julgar pela camada estética ou pelo gosto pessoal.

Quando os decisores são definidos desde o início, as pessoas importantes participam das apresentações e entendem os critérios adotados. O briefing, nesse sentido, funciona como um meta projeto, o projeto do projeto, porque planeja como o trabalho vai acontecer.
...
## Natureza do projeto, contexto e resultados desejáveis

A primeira etapa do escopo é a natureza do projeto. O designer precisa identificar o que é o projeto, para que ele serve, por que o cliente entrou em contato, por que o designer está oferecendo aquilo, qual objetivo será cumprido e qual resultado se deseja alcançar.
...
Nessa etapa, também aparecem as primeiras responsabilidades. O designer precisa entender o que o cliente espera dele e o que ele pode esperar do cliente. Essa conversa define papéis antes que o projeto avance para diagnóstico, pesquisa e execução.
...
Esse diagnóstico ainda não é a pesquisa completa. Ele é uma leitura inicial feita a partir da lente do cliente. O designer escuta como o cliente enxerga o próprio negócio, suas vantagens competitivas, seus clientes, seu mercado e seus concorrentes.

No diagnóstico de negócio, entram proposta de valor, posicionamento, diferenciais, pontos fortes, pontos fracos, reputação, pontos de contato, stakeholders, fontes de receita, produtos, serviços, preços, promoções, recursos principais e atividades principais.

Proposta de valor é o que o negócio oferece ao público e qual valor gera para ele. Pontos de contato envolvem não só consumidor final, mas todos os stakeholders: colaboradores, parceiros, concorrência e demais pessoas ligadas à marca. Esse mapeamento pode evoluir depois para um mapa de stakeholders.

Fontes de receita exigem cuidado na forma da pergunta. Em vez de perguntar diretamente quanto o cliente fatura, o designer pode investigar quais produtos ou serviços mais geram resultado, quais são os carros chefe e onde há maior retorno. A justificativa é construir uma estratégia de marca mais eficiente.

Recursos principais são os elementos de que o negócio precisa para executar seu produto ou serviço. Atividades principais são os processos que ele realiza para entregar valor ao público. Em uma empresa de água, por exemplo, coletar, engarrafar, rotular e distribuir fazem parte das atividades.

O ponto estratégico é não criar uma marca sem conhecer a empresa. Uma boa marca não inventa uma fantasia sobre o negócio, mas evidencia o que há de melhor nele. Ela parte do núcleo, do core da empresa, para comunicar algo que a empresa consiga provar ao longo do tempo.
...
O diagnóstico começa por identificar concorrentes e mapear onde eles são fortes ou fracos, para quais públicos funcionam melhor e o que têm de bom ou ruim. Também envolve analisar pontos de paridade, ou seja, padrões do mercado que todos seguem porque fazem parte da dinâmica do setor.

O designer deve perguntar como o mercado funciona, quais são seus paradigmas, o que pode ou não pode ser mudado, quais oportunidades existem, quais barreiras aparecem e quais tendências influenciam o contexto. A inovação nasce justamente de entender o status quo e encontrar onde existe espaço para se posicionar de forma diferente.
...
As perguntas podem investigar o que o público quer, o que espera, qual sonho nenhum concorrente entrega, do que tem medo, qual solução procura, quais obstáculos enfrenta, quais crenças limitam a compra e por que ainda não compra da marca. Essas respostas orientam a pesquisa posterior.

Depois dos diagnósticos de negócio, mercado e público, o designer tem o ponto de partida da investigação. Alguns buracos ficarão vazios, e esses vazios mostram exatamente onde a pesquisa precisa se aprofundar.

## Cronograma, orçamento e recursos do projeto
...
O orçamento discutido nessa parte não é apenas quanto o designer vai receber. Ele envolve quanto custa realizar o projeto, incluindo etapas, fornecedores, materiais e demandas adicionais. Registrar isso ajuda o cliente a entender o custo real da execução.
...
No exemplo de redesign para um bar que quer atrair mulheres, o critério pode ser medir o público antes e depois. Se antes o bar recebia majoritariamente homens e, após a mudança de comunicação, passa a atrair majoritariamente mulheres, há um indicador para avaliar o efeito do projeto.

Outro exemplo envolve uma loja de tênis que vende produtos de baixo valor e não consegue vender modelos mais caros porque atrai um público que reclama do preço. A mudança de comunicação pode buscar um público disposto a pagar mais por qualidade, inclusive com estratégia online ou uma experiência premium.

O design de marcas também pode medir equity, valor de marca, adequação da comunicação ao público desejado e atração de clientes de determinado perfil. Além disso, existem critérios técnicos, como simplicidade da marca, adequação ao mercado, possibilidade de registro e diferenciação em relação à concorrência.

## Responsabilidades, decisores, implementação e apêndice

Na etapa final do escopo, o briefing precisa definir responsabilidades por etapa e decisores do projeto. É necessário saber com quem o designer vai conversar, quem aprova as etapas, quem decide se o projeto avança e quem tem a palavra final quando há mais de um tomador de decisão.
...
O briefing não termina na reunião inicial. Se faltar alguma pergunta, o designer pode pedir resposta por WhatsApp, e-mail ou outro canal. Como documento de gestão, o briefing acompanha o projeto e é retomado sempre que for necessário verificar o que foi acordado e como cada etapa deve ser resolvida.

## Limitações do briefing
...
O cliente pode estar enviesado. Ele pode falar mal de concorrentes que, na realidade, não são tão ruins, ou superestimar os benefícios da própria empresa porque está falando de si mesmo. Por isso, o designer não pode depender apenas da visão do cliente.

É nesse ponto que a pergunta inicial volta. Fazer briefing só com informações do cliente é como fazer o resumo de um livro que você não leu. O designer talvez nunca tenha trabalhado naquele mercado, nunca tenha operado um negócio semelhante e nunca tenha se comunicado com aquele público.

Um briefing de cinco linhas para um projeto estratégico é insuficiente. Ele pode até dar uma sensação de início, mas não permite falar com profundidade sobre o negócio, o mercado ou o público. Para construir um bom resumo, é preciso ler o livro. Para construir um projeto estratégico, é preciso investigar.

## Os três problemas que o briefing não resolve sozinho
...
Uma decisão de cor deve considerar concorrência, diferenciação, intenção de parecer ou não parecer com o mercado e público que se quer atrair. Da mesma forma, perguntar em quanto tempo o cliente precisa do projeto pode gerar respostas inviáveis. O prazo deve partir do processo necessário e ser negociado com o cliente.

Um bom briefing depende de quem aplica. Se o designer não faz as perguntas certas, o briefing não fica bom. A experiência ajuda a perceber quais perguntas eram desnecessárias, quais faltaram e de que forma perguntar para gerar respostas melhores.

O terceiro problema é que o briefing não dá conta de tudo no contexto atual. Talvez funcionasse melhor quando os designers faziam majoritariamente projetos técnicos, mas projetos estratégicos precisam de mais informações. Essas informações precisam vir da investigação e da pesquisa para permitir decisões corretas e uma estratégia capaz de gerar resultado.

## Coloque em prática

Revise o briefing que você usa hoje e separe o que é gestão do projeto do que pertence à pesquisa, à proposta ou ao contrato.

Antes de montar perguntas prontas, liste os tópicos que você precisa investigar: natureza do projeto, contexto, resultados desejáveis, negócio, mercado, público, cronograma, orçamento, critérios, responsabilidades, decisores, implementação e materiais de apoio.

Em cada novo projeto, defina com o cliente onde ele está, onde quer chegar e como vocês vão medir se chegaram lá. Depois, use os vazios do briefing como direção para a pesquisa.
