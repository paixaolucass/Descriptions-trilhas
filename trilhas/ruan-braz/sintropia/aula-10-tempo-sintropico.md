...
- Executar o mapeamento de sete dias do uso do tempo.
- Distinguir investimentos, operações, dívidas e vazamentos.
- Aplicar uma matriz de decisão para automatizar, eliminar, delegar ou blindar tarefas.
- Estruturar uma primeira compra de capacidade por delegação.

## Tempo sintrópico e presença
...
## Os quatro baldes do tempo

O aluno deve classificar o uso do tempo em quatro baldes: investimentos, operações, dívidas e vazamentos. Essa classificação pode ser feita em caderno, Figma, planilha ou qualquer tabela simples.

Investimentos são usos de tempo que aumentam capacidade futura, como habilidades novas, saúde, ativos e relacionamentos. Mesmo quando o retorno não é imediato, existe intenção e presença.

Operações são atividades que mantêm a vida ou o negócio rodando, como alimentação, administração da casa, rotinas e tarefas necessárias. Elas podem ser otimizadas, mas não simplesmente cortadas.

Dívidas são retrabalhos, pendências, urgências criadas, promessas ruins e complexidades assumidas. Vazamentos são dispersões, redes sociais, interrupções, tarefas sem dono e blocos que não geram valor, não mantêm operação essencial e não têm prazo claro para terminar.

## Mapear sete dias reais

O primeiro passo é reservar sete dias para mapear onde o tempo está sendo gasto. A recomendação é começar à meia noite e terminar à meia noite, registrando o que aconteceu de fato, não o que a pessoa gostaria que tivesse acontecido.
...
Esses dados devem ser sincronizados com o mapeamento da semana. Ao final dos sete dias, o aluno classifica cada bloco nos quatro baldes e ganha clareza sobre o fluxo real do tempo.
...
Dívidas e vazamentos não devem ser tratados como se fossem prioridades. Eles devem ser eliminados, automatizados ou reduzidos, porque consomem capacidade sem sustentar a vida nem aumentar o futuro.
...
## Regras, agenda e evidências de conclusão
...
- Mapeie sete dias reais do seu tempo, de meia noite a meia noite.
- Classifique cada bloco em investimento, operação, dívida ou vazamento.
- Reserve uma hora semanal para matriz de decisão e matriz de prioridade.
- Escolha uma tarefa para delegar e escreva processo, resultado esperado, prazo e critério de aprovação.
