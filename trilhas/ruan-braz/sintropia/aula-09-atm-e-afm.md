...
- Identificar a diferença entre autonomia mínima e autonomia atual.
- Aplicar o cálculo da autonomia financeira mínima.
- Aplicar o cálculo da autonomia temporal mínima.
- Reconhecer dívidas semanais de tempo como indicadores de desregulação.

## Autonomia mínima e autonomia atual

A aula explica o cálculo da autonomia financeira mínima, autonomia temporal mínima, autonomia financeira atual e autonomia temporal atual. A diferença entre mínimo e atual é essencial para gerar discernimento.

O objetivo é entender como está o cenário de hoje e qual é o mínimo necessário para entrar em regulação. Regulação, nesse contexto, significa fazer as coisas começarem a entrar no eixo.

O mínimo não representa liberdade plena, lucro ou sobra confortável. Ele representa o ponto em que a pessoa deixa de operar abaixo da linha crítica.
...
A lógica do cálculo é simples: entrada confirmada menos custos fixos essenciais e dívidas mínimas. O resultado mostra se a pessoa está no mínimo, abaixo dele ou acima dele.
...
Esse zero ainda é arriscado, porque viver apenas no empate é mais negativo do que positivo. Mais adiante, o ideal será gerar ROI e lucro, mas o primeiro passo é visualizar que abaixo desse ponto o cenário é crítico.
...
## Dívidas sociais, vazamentos e o resultado semanal
...
## O índice que explica por que não dá tempo

O resultado da ATM funciona como um índice de clareza. Ele responde por que a pessoa não consegue fazer tudo que gostaria: ela pode estar devendo tempo para si mesma semanalmente.

Esse cálculo transforma sensação em dado. Em vez de apenas sentir que falta tempo, a pessoa vê onde o tempo está sendo gasto, quais saídas são inevitáveis, quais são dívidas e quais são vazamentos.

A partir dessa visão, é possível começar a escolher o que reduzir, cortar, reorganizar ou compensar. O cálculo não resolve tudo sozinho, mas mostra onde a regulação precisa começar.

## Coloque em prática

- Calcule sua renda mensal confirmada.
- Some seus custos fixos essenciais e suas dívidas mínimas do mês.
- Calcule suas cento e sessenta e oito horas semanais e subtraia trabalho, sono, estudo, cuidados, deslocamentos e compromissos.
- Identifique se você está com déficit financeiro, déficit temporal ou ambos.
