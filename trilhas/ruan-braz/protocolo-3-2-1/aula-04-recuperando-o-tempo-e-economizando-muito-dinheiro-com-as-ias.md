...
- Identificar ferramentas de IA com bom custo-benefício para texto, imagem, vídeo, música e código
- Reconhecer os principais recursos disponíveis dentro de cada ferramenta apresentada
- Distinguir entre ferramentas especializadas e hubs que reúnem múltiplos modelos
- Aplicar uma postura de autodidatismo para explorar ferramentas de forma independente

## Critério de seleção e postura de aprendizado

O objetivo desta aula é apresentar as principais ferramentas de inteligência artificial com o melhor custo-benefício nas categorias de texto, imagem, vídeo, música e código. A seleção não é necessariamente das ferramentas mais avançadas do mundo, mas daquelas que entregam excelente resultado por um custo acessível. Cada ferramenta é aberta e apresentada de forma rápida e prática.

Um ponto importante estabelecido antes do tour: o objetivo não é ensinar a clicar em cada botão, e sim desenvolver nos alunos a independência para abrir qualquer ferramenta, aprender sozinho e seguir com autodidatismo. Esse é um princípio central para quem quer se desenvolver no cenário de IA em evolução constante.
...
O Suno é a ferramenta apresentada para geração de músicas. Funciona a partir de um prompt textual em que o usuário descreve a música que quer gerar, incluindo o estilo. Também é possível inserir a letra completa da música no campo de lyrics, subir um áudio de exemplo como referência, adicionar inspirações e marcar a opção instrumental para gerar a música sem voz.

Entre as opções avançadas, o usuário pode definir uma persona de voz, um áudio de referência, descrever o estilo com mais detalhes, escolher entre voz feminina ou masculina, ajustar o grau de "estranheza" na voz e indicar influências de estilo. Os modelos disponíveis são V2, V3, V4, V4.5 e V4.5 Plus (exclusivo do plano Pro). A plataforma inclui biblioteca pessoal para encontrar as músicas geradas, rádio para ver o que outros usuários estão criando e área de exploração de músicas do público.
