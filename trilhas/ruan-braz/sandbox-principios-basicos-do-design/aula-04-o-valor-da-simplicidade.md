...
- Distinguir quando "menos é mais" é válido e quando não se aplica no design
- Reconhecer a simplicidade como princípio fundamental para projetos comerciais eficazes
- Identificar a diferença entre design e arte, e por que confundi-los é perigoso para iniciantes
- Aplicar o olhar analítico sobre referências visuais para absorver o princípio da simplicidade

## "Menos é mais": o que essa frase realmente diz

A frase "menos é mais" nasceu do design, mas extrapolou tanto que hoje é usada em qualquer contexto. É comum ouvir pais, tios e pessoas próximas repetirem isso como verdade absoluta.

E ela não é uma mentira. Dentro de muitos contextos, menos realmente é mais. O problema é tratar isso como regra universal. Às vezes, mais informação é exatamente o que vai transmitir a mensagem com maior precisão. A frase não é errada, mas não é completa.

Isso importa porque o design não é sobre deixar o mundo mais bonito. Design é sobre conduzir a percepção das pessoas em uma direção específica. E cada projeto tem uma direção diferente.
...
## Por que a simplicidade é o ponto de partida para quem está começando

Mesmo que o "menos é mais" não seja uma lei universal, existe um motivo preciso pelo qual ele é o ponto de partida recomendado para iniciantes. É fácil se perder quando se está começando: colocar informação demais, fazer uma composição que confunde em vez de comunicar. A simplicidade evita esse desvio.

Mas há outro motivo mais importante: antes de quebrar uma regra, é preciso dominá-la. Quem tenta subverter fundamentos que ainda não entendeu tende a produzir designs que não funcionam, mesmo com intenção criativa por trás.
...
Confundir design com arte é uma armadilha comum, especialmente para quem está começando. Querer se expressar dentro dos projetos parece natural. Mas o design comercial tem um objetivo claro: transmitir uma mensagem para um público específico, chamar a atenção e criar uma boa experiência.

Tentar se expressar além desse objetivo faz o designer desviar do projeto. A clareza, como foi visto na aula anterior, é o princípio básico. A simplicidade vem logo em seguida: ser simples é ser preciso, é ser eficaz.

Esses dois princípios, clareza e simplicidade, formam a base sobre a qual os outros conceitos serão construídos ao longo do módulo.
...
Abra a pasta no Pinterest indicada abaixo do vídeo.

Olhe cada imagem e se pergunte não "é difícil de fazer?", mas "a composição no final foi simples?".

Observe onde está o foco principal, como a margem foi usada, quantos elementos existem e como a tipografia conduz o olhar.

Registre o que chamou sua atenção e tente aplicar essas escolhas no seu próximo projeto.
