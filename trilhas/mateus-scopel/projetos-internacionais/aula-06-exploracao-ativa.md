...
- Identificar plataformas e rotas para prospectar clientes internacionais.
- Distinguir Behance, Upwork, Contra, Toptal, Fiverr, Indie Hackers e Google Ads.
- Reconhecer a Upwork como principal recomendação inicial para designers.
- Estruturar uma sequência de prospecção compatível com o próprio nível profissional.
...
O objetivo não é esgotar todas as opções, mas dar um mapa inicial para o aluno perceber que a prospecção internacional pode ser estruturada.
...
Ele também cita a importância de SEO dentro dos projetos, para que possíveis clientes encontrem o designer quando pesquisarem por estilos, serviços ou categorias específicas.
...
Apesar disso, ele não colocaria o Behance como primeira solução de prospecção ativa. Considera uma tentativa válida, especialmente por não exigir pagamento para se candidatar, mas não a principal rota.
...
Ele destaca que é uma das maiores plataformas de trabalho freelance do mundo. Embora exista competitividade, é possível se diferenciar com boas propostas, perfil bem definido e escolha de um tipo específico de cliente.
...
Além de projetos pontuais, a Upwork também pode gerar oportunidades de tempo integral remoto, como aconteceu com ele no contrato atual.
...
Apesar do potencial, não recomenda começar por ali. Para quem está no primeiro momento do mercado internacional, plataformas como a Upwork tendem a ser mais acessíveis.
...
Pode ser um início para alguns perfis, mas exige consciência de que talvez não seja o ambiente mais favorável para trabalhos de maior ticket.
...
Para designers, pode ser um espaço para ajudar empreendedores, melhorar interfaces, contribuir com landing pages e encontrar projetos em crescimento.
...
Por isso, ele recomenda anúncios como uma das últimas etapas. Ainda assim, eles podem ser úteis para segmentar por localização e idioma quando o designer já tiver renda e estrutura para investir.
...
A mensagem final é que não é preciso ter inglês maravilhoso para começar. Muitas dessas plataformas permitem conversar por chat, usando as ferramentas da aula anterior.

## Coloque em prática

Escolha uma plataforma para explorar primeiro.

Se você está começando, priorize a Upwork. Depois:

- observe projetos parecidos com o serviço que você presta;
- analise como os clientes escrevem as demandas;
- veja quais perfis aparecem bem posicionados;
- anote palavras-chave, categorias e tipos de projeto recorrentes.

Em seguida, revise seu portfólio e identifique o que precisa estar pronto antes da primeira proposta.
