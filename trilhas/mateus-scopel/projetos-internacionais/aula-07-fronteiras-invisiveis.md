...
- Identificar diferenças culturais que afetam projetos de design internacional.
- Reconhecer riscos ligados a gestos, cores, símbolos, números e direção de leitura.
- Aplicar pesquisa cultural antes de criar peças para outros países.
- Distinguir adaptação cultural de uso de estereótipos.
...
Muitos designers negligenciam esse ponto quando começam a trabalhar para fora. A aula mostra que não basta traduzir o idioma: também é preciso pesquisar como o público de outro país interpreta signos visuais e culturais.
...
Nos Estados Unidos, o gesto também pode ser positivo, como no Brasil, mas em certos contextos pode ser associado a grupos de extrema direita. Por isso, mesmo um gesto aparentemente simples precisa ser avaliado no contexto cultural.

## O sinal de gostei

Outro exemplo é o sinal de gostei. No Brasil, ele comunica aprovação, algo positivo ou tudo certo.

Em alguns países, o significado muda. Na Grécia, pode ser considerado insulto. No Irã, é altamente ofensivo e equivale ao dedo do meio. No Japão, pode ser confundido com gesto para homem na linguagem gestual japonesa.

Nos Estados Unidos, o sentido é mais próximo do brasileiro: bom, aprovado, ok. Isso mostra que alguns mercados terão menos atrito cultural para brasileiros, mas ainda exigem cuidado.
...
Outro exemplo é o amarelo. No Brasil, pode estar ligado a otimismo e alegria. Na França, pode remeter a traição e inveja. Isso não significa que o amarelo sempre terá esse sentido, mas mostra que o contexto precisa ser pesquisado.
...
Se a peça for romântica e voltada para a França, por exemplo, usar amarelo como cor principal pode gerar uma associação indesejada. O ponto é tomar decisões visuais com consciência cultural.
...
Esse exemplo mostra que um ícone familiar em um país pode não ser o símbolo mais usado em outro. A escolha visual deve considerar o repertório local.
...
Esse tipo de detalhe pode impactar peças, campanhas, nomes, quantidades, planos e interfaces. A decisão parece pequena, mas pode mudar a percepção cultural.

## Pessoas, etnia e contexto visual

Ao criar anúncios ou peças para outros países, também é necessário considerar quem aparece na imagem. Feições, etnia, roupas e contexto visual influenciam a identificação do público.

Se a peça é voltada para um país europeu ou para o Japão, por exemplo, pode ser necessário usar pessoas e referências visuais coerentes com aquele contexto.

Esse cuidado não é apenas estético. Ele ajuda a evitar a sensação de peça genérica, deslocada ou culturalmente inadequada.
...
Isso mostra que adaptar um layout internacional não é apenas traduzir texto. A própria arquitetura visual pode mudar conforme o idioma e a direção de leitura.
...
Também menciona alimentos, roupas e história como pontos sensíveis. O designer precisa evitar gafes e decisões que pareçam normais no Brasil, mas carreguem outro peso em outro país.
...
Escolha um país para o qual você gostaria de trabalhar.

Pesquise antes de criar qualquer peça:

- gestos comuns e gestos ofensivos;
- cores com associações positivas ou negativas;
- símbolos e ícones locais;
- direção de leitura;
- formato de data;
