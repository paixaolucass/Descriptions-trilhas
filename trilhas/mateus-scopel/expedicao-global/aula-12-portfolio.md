...
- Estruturar projetos de portfólio dentro da Upwork.
- Aplicar palavras-chave em títulos, descrições, skills e conteúdos do projeto.
- Reconhecer quando usar projetos reais ou fictícios.
- Distinguir portfólio para Upwork de cases extensos para Behance.
...
Ele não precisa ser perfeito ou extremamente longo, mas precisa mostrar com clareza a capacidade do profissional.
...
Esses títulos incluem palavras-chave que facilitam a busca e ajudam o cliente a interpretar o tipo de trabalho antes de abrir o projeto.
...
Para a Upwork, não é necessário criar um case enorme com 30 telas, todos os mockups possíveis e explicações detalhadas de cada decisão.

O cliente geralmente está olhando muitas propostas. Ele abre o portfólio para verificar rapidamente se o profissional sabe fazer o que ele precisa.

Por isso, algumas telas bem escolhidas podem ser suficientes. Projetos maiores podem ser publicados, mas é possível selecionar as imagens principais para não deixar a experiência excessivamente longa.
...
Cases muito completos podem funcionar em outras estratégias de mercado internacional, mas dentro da Upwork o foco deve ser clareza, objetividade e prova visual suficiente.
...
A recomendação é publicar algo bom o suficiente para mostrar criatividade e capacidade, sem transformar o portfólio em bloqueio.

## Coloque em prática

Adicione pelo menos três projetos ao seu portfólio.

Para cada projeto, revise:

- título com palavras-chave;
- descrição em inglês;
- tags e skills relevantes;
- thumbnail forte;
- imagens principais;
