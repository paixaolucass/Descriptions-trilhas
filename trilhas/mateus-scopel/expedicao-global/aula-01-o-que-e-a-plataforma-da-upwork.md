...
- Reconhecer a lógica de reputação da Upwork.
- Identificar por que começar pequeno aumenta a chance do primeiro projeto.
- Estruturar uma progressão inicial de preço com base em depoimentos.
- Reconhecer a Upwork como ambiente de propostas, contratos e convites.
...
Quando um perfil novo cobra alto sem reputação, o risco percebido pelo cliente aumenta. Mesmo que o portfólio pareça bom, o cliente pode preferir alguém que já tenha provas dentro da Upwork.

## Reputação como principal moeda

Dentro da Upwork, a troca com o cliente passa muito pela reputação. Um perfil novo ainda não tem depoimentos, insígnias ou dados de performance.
...
Quando mudou a estratégia e passou a focar em projetos pequenos, conseguiu o primeiro trabalho.
...
Mais importante do que o valor foi o depoimento. Com essa primeira prova, o perfil deixou de parecer totalmente novo.

## Escalada de preço com depoimentos

Depois do primeiro projeto, a orientação é aumentar aos poucos. Se o primeiro projeto foi feito a 5 dólares por hora, depois do primeiro depoimento pode subir para 10 dólares. Depois de mais um depoimento, pode subir para 15 dólares.
...
Mas o começo exige paciência. O primeiro passo é curto prazo: conseguir o primeiro projeto, o primeiro depoimento e a primeira experiência internacional.
...
Com o tempo, a meta é que o profissional precise enviar menos propostas. Clientes passam a encontrar o perfil, avaliar o histórico e enviar convites diretamente.
...
A proposta da trilha é encarar esse processo com método, começando pequeno para construir reputação e crescer de forma mais sólida.

## Coloque em prática

Defina sua meta inicial dentro da Upwork:

- um serviço pequeno que você conseguiria entregar em até duas horas;
- um valor baixo o suficiente para reduzir o risco para o cliente;
- uma entrega que possa gerar um bom depoimento;
