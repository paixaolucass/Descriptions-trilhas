...
- Identificar as principais áreas da interface da Upwork.
- Reconhecer funções de feed, propostas, contratos, pagamentos e mensagens.
- Aplicar cuidados básicos para evitar golpes e problemas de contato fora da plataforma.
- Identificar onde ficam métricas, configurações, verificação e suporte.
...
No painel inicial também aparecem informações como connects, anúncios, propostas, ofertas, convites, contratos, projetos feitos e valores ganhos dentro da plataforma.

## Find Work e projetos salvos

A aba Find Work leva o usuário de volta ao feed de projetos. Nela, o freelancer acompanha as oportunidades abertas e começa sua busca.

Também há a área de projetos salvos. Quando o aluno clica no coração de um projeto no feed, ele fica guardado ali para ser revisado depois.

Essa função ajuda a separar oportunidades interessantes antes de enviar proposta. O aluno pode filtrar, salvar e depois avaliar com mais calma.

## Propostas, ofertas e serviços
...
Ele também explica que existem duas formas de cobrar: por projeto fechado ou por hora. Em trabalhos por hora, a Upwork permite registrar manualmente o tempo ou usar o aplicativo da própria plataforma.
...
Sair da Upwork só faz sentido depois de avaliar o cliente, já ter trabalhado com ele e ter segurança de que a relação é confiável.
...
Ele afirma que a maioria das pessoas não olha essa área, mas ela funciona como uma documentação completa. Também há requests de suporte e atualizações da Upwork, úteis para acompanhar mudanças de taxa e novas funcionalidades.
...
Por isso, não recomenda depender dela. Pode melhorar no futuro, mas ainda não é tratada como ferramenta central da estratégia.

## Perfil e dados públicos

Na área da conta, ficam as informações do perfil: foto, descrição, perfis especializados, consultorias, portfólio, histórico de trabalho, educação, idioma, skills, depoimentos, certificados e outros dados.
...
Essas ofertas podem ajudar o freelancer a melhorar o próprio fluxo de trabalho, mas não são o foco inicial da trilha.
...
Abra sua conta na Upwork e localize:
...
Não envie propostas ainda. Primeiro, navegue pela plataforma e anote dúvidas sobre cada área.
