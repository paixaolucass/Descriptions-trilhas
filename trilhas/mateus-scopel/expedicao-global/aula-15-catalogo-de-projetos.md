...
- Identificar o catálogo de projetos como forma adicional de captação.
- Estruturar pacotes com planos, preços, prazos, revisões e entregáveis.
- Aplicar palavras-chave, imagens, requisitos, etapas e perguntas frequentes.
- Reconhecer limitações do catálogo para perfis sem autoridade inicial.
...
O catálogo permite criar pacotes de serviços que clientes podem comprar diretamente pelo perfil.
...
Essa estrutura transforma um serviço em produto mais claro, com opções de compra para o cliente.

## Descrição, categoria e tags
...
Ele recomenda não deixar revisões adicionais baratas demais, porque isso pode incentivar excesso de revisão.

## Galeria, requisitos e etapas

Na galeria, o aluno escolhe capa, imagens, vídeos e documentos. A galeria funciona quase como um portfólio do serviço vendido.

Também é possível criar requisitos, com perguntas que o cliente precisa responder antes de iniciar. Isso ajuda a coletar informações essenciais.

O catálogo ainda permite descrever etapas do projeto e adicionar perguntas frequentes, inclusive usando inteligência artificial para levantar dúvidas prováveis do cliente.
...
Esse limite precisa ser configurado com responsabilidade, considerando capacidade real de entrega.

## Utilidade e dificuldade inicial
...
Crie um pacote simples no catálogo.
...
- descrição clara;
- categoria;
- até cinco tags fortes;
- três planos;
- preço e prazo de cada plano;
- revisão adicional;
- entrega rápida;
