...
- Identificar como adicionar depoimentos externos na Upwork.
- Estruturar uma solicitação de depoimento para clientes antigos.
- Reconhecer a função do LinkedIn na verificação do depoimento.
- Aplicar certificados, histórico e experiências como reforços de autoridade.
...
Esse contato prévio aumenta a chance de resposta e evita que o cliente receba um e-mail inesperado da plataforma.

## Dados necessários

Para solicitar o depoimento, o profissional precisa preencher primeiro nome, sobrenome e e-mail do cliente.

O cliente recebe a solicitação por e-mail. Além disso, é necessário que ele tenha perfil no LinkedIn, porque a Upwork usa essa informação para verificar se a pessoa é real.

Isso impede que depoimentos sejam enviados por qualquer pessoa sem validação, preservando a seriedade da plataforma.
...
Se a pessoa não tem clientes antigos, pode pedir para alguém com quem trabalhou ou que conheça bem a qualidade do trabalho, como um colega profissional.
...
Ele ainda não adicionou esse tipo de teste, mas recomenda para quem tiver certificado.
...
No fechamento, ele retoma a importância de todas as partes do perfil: foto, bio, perfis especializados, barra lateral, consultoria, portfólio, skills, catálogo, depoimentos, certificados e histórico.

## Coloque em prática

Liste três pessoas que poderiam deixar um depoimento externo para você.

Para cada uma, verifique:

- se há relação profissional real;
- se a pessoa tem LinkedIn;
- qual projeto foi feito;
- qual cargo e empresa devem ser informados;
